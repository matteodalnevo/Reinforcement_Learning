...
# %%
q_net.model.save_weights('weights_ddqn_cnn.weights.h5')
...
# %%
# Save the data
#np.savez("data_ddqn_cnn.npz", max_steps=max_steps, n_fruit_eaten_ep=n_fruit_eaten_ep, n_wall_hit_ep=n_wall_hit_ep, n_body_hit_ep=n_body_hit_ep, rewards_ep=rewards_ep)