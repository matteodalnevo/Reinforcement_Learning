...
a2c_net_test.load_weights('./weights/weights_ppo.weights.h5')
...
# %%
# Save the data
# np.savez("./data/test/data_ppo.npz", max_steps=max_steps, n_fruit_eaten_ep=n_fruit_eaten_ep, n_wall_hit_ep=n_wall_hit_ep, n_body_hit_ep=n_body_hit_ep, rewards_ep=rewards_ep)
