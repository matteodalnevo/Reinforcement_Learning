...
# %%
# a2c_net_train.save_weights('weights_a2c_cnn.weights.h5')
...
# %%
# Save the data
# np.savez("./data/train/data_a2c_cnn.npz", max_steps=max_steps, n_fruit_eaten_ep=n_fruit_eaten_ep, n_wall_hit_ep=n_wall_hit_ep, n_body_hit_ep=n_body_hit_ep, rewards_ep=rewards_ep)